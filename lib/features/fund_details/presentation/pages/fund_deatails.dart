        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(fontSize: 16, color: Ucolors.primary, fontFamily: FontFamily.medium,),
            ),
          ],
        ),
      );
          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Loading fund details...',
                  style: TextStyle(color: Ucolors.darkgrey, fontFamily: FontFamily.medium,),
                ),
              ],
            ),
          ),
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton.icon(
              ...
              label: const Text("Retry",style: TextStyle(fontFamily: FontFamily.medium),),
...
//       automaticallyImplyLeading: false,
//       pinned: true,
//       flexibleSpace: WebCustomAppBarNormal(
//         backgroundColor: Ucolors.light,
//         actionsPadding: 10,
//         title: 'Fund Details',
//         action: [
...
class WebOverviewScreen extends GetView<FundDetailsController> {
  ...
  Widget build(BuildContext context) {
    ...
    // One Single Outer Obx to safely observe changes for all fundamental details
    return Obx(() {
      final fund = controller.fundDetail.value;
      ...
      return Column(
        ...
        children: [
            ...
            leftChild: CustomContainer(
              ...
              child: Column(
                children: [
                  ...
                  // Safe reactive conditional check for NAV graph data
                  Builder(
                    builder: (context) {
          ...
          // ==========================================
          // SECTION 2: TRAILING RETURNS & PERFORMANCE GRAPH
          // ==========================================
          if (fund != null) ...[
            Builder(
              builder: (context) {
          ...
          // ==========================================
          // SECTION 3: FUND ALLOCATION & RISK ANALYSIS
          // ==========================================
          _buildResponsiveLayout(
            context: context,
            leftChild: CustomContainer(
              ...
              child: Column(
                children: [
                  ...
                  _buildPortfolioSection(portfolioEntity),
                ],
              ),
            ),
            rightChild: CustomContainer(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    textAlign: TextAlign.center,
                    style: UTextStyles.small.copyWith(color: Ucolors.darkgrey, fontFamily: FontFamily.medium,),
                  ),
                  const Gap(8),
                  DashedLine(color: Colors.grey.shade400),
                  const Gap(8),
  ...
  // ==========================================
  // HELPER REFACTORING & CLEANUP METHODS
  // ==========================================
  ...
  Widget _buildPillTabBar({required List<Tab> tabs}) {
    return Container(
      height: 35,
      decoration: BoxDecoration(
        color: Colors.grey.shade100,
      ...
      child: TabBar(
        ...
        labelStyle: const TextStyle(fontWeight: FontWeight.w600, fontSize: 12, fontFamily: FontFamily.medium,),
      ...
      child: Column(
        children: [
          ...
          SizedBox(
            ...
            child: TabBarView(
              children: [
                _buildAllocationTab(assetList, "Assets"),
                _buildAllocationTab(mcapList, "Market\nCap"),
              ],
            ),
          ),
  ...
  Widget _buildSectorTab(var entity) {
    ...
    for (int i = 0; i < count; i++) {
      combinedList.add(MapEntry(names[i], values[i]));
    }
    combinedList.sort((a, b) => b.value.compareTo(a.value));
    final top10Items = combinedList.take(10).toList();
  ...
  Widget _buildStockTab(var entity) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          const Gap(10),
          const DashedLine(dashSpace: 0, color: Ucolors.borderColor),
          const Gap(10),
          ...top10Items.map((item) {
            return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(fontSize: 12, color: Colors.grey.shade500, fontFamily: FontFamily.medium,),
          ),
          const SizedBox(height: 12),
          TextButton.icon(
            onPressed: () {
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          Text(
            label,
            style: TextStyle(color: Colors.grey.shade700, fontSize: 12, fontFamily: FontFamily.medium,),
          ),
          const Spacer(),
          Text(
            value,
            style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 12, fontFamily: FontFamily.medium,),
          ),
        ],
      ),
    );
      ...
      child: Row(
        children: [
          const SizedBox(
            ...
            child: Text(
              'Period',
              style: TextStyle(fontWeight: FontWeight.w700, fontSize: 14, fontFamily: FontFamily.medium),
            ),
          ),
          const Expanded(
            child: Text(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: const Text(
                "Start SIP",
                style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, fontFamily: FontFamily.medium,),
              ),
            ),
          ),
          const Gap(12),
    ...
    return _DesktopCard(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            'Fund Manager(s)',
            style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700, fontFamily: FontFamily.medium,),
          ),
          const Gap(16),
          if (managers.isNotEmpty)
            Wrap(
  ...
  Widget _buildDetailRow(String label, String value) {
    return Row(
      ...
      children: [
        ...
        Text(
          value,
          style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w700, fontFamily: FontFamily.medium,),
        ),
      ],
    );
  }
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    'Exit Load:',
                    style: TextStyle(fontSize: 12, color: Colors.grey, fontFamily: FontFamily.medium,),
                  ),
                  ReadMoreText(
                    fund?.exitLoad.toString() ??
...
class DesktopSideTabs extends StatelessWidget {
  final int selectedIndex;
  final ValueChanged<int> onTap;

  const DesktopSideTabs({
    super.key,
...
Widget _dot() {
  return const Text('•', style: TextStyle(fontSize: 12, color: Colors.grey, fontFamily: FontFamily.medium,));
}
...
Widget _metaText(
  ...
  return Text(
    text,
    style: TextStyle(fontSize: 10, color: color, fontWeight: fontWeight, fontFamily: FontFamily.medium,),
  );
}
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          const Gap(8),
          Text(title, style: const TextStyle(fontSize: 12, fontFamily: FontFamily.medium,)),
          const Spacer(),
          Text(
            value,
            style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 12, fontFamily: FontFamily.medium,),
          ),
        ],
      ),
    );
