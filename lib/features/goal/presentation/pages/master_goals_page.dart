        ...
        action: [
          Obx(() {
            ...
            return TextButton(
              ...
              child: Text(
                "View All Goals",
                style: TextStyle(color: Ucolors.primary,  fontFamily: FontFamily.bold,),
              ),
            );
          }),
        ],
                    ...
                    if (mutualController.searchFund.isEmpty) {
                      return Center(
                        child: Text(
                          ...
                          style:
                          TextStyle(color: Colors.grey.shade600,fontFamily: FontFamily.bold,fontSize: 16),
                        ),
                      );
                    }
          ...
          child: Center(
            child: Column(
              children: [
                ...
                Text(
                  "Please add funds",
                  style: TextStyle(color: Colors.grey.shade600,fontFamily: FontFamily.bold,),
                ),
              ],
            ),
          ),
        ...
        children: [
          ...
          TextFormFieldCustom(
            ...
            method: TextFieldCustom(
              ...
              suffixIcon: Container(
                ...
                child: const Text(
                  "*",
                  style: TextStyle(color: Colors.red, fontSize: 16,fontFamily: FontFamily.medium),
                ),
              ),
            ),
          ),
          Obx(() => controller.goalError.isNotEmpty
            ...
            child: Text(
              ...
              style: TextStyle(fontSize: 12, color: Ucolors.red,fontFamily: FontFamily.medium),
            ),
          )
      ...
      builder: (controller) {
        if (controller.isMasterGoalLoading.value) {
          return const Scaffold(
              body: Center(child: GoalShimmerGrid()));
        }
