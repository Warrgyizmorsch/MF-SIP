...
import '../../domain/usecases/get_single_goal_use_case.dart';
  ...
  void dependencies() {
    ...
    Get.lazyPut(
      () => UpdateGoalFundOrderUseCase(
        goalRepository: Get.find<GoalRepositoryImpl>(),
      ),
      fenix: true,
    );
    ...
    Get.lazyPut(
      () =>
          GetSingleGoalUseCase(goalRepository: Get.find<GoalRepositoryImpl>()),
      fenix: true,
    );

    Get.lazyPut(
      () =>
          LinkFundToGoalUseCase(goalRepository: Get.find<GoalRepositoryImpl>()),
      fenix: true,
    );
    ...
    Get.lazyPut<GoalUseCases>(
      () => GoalUseCases(
        ...
        goalFundOrderUseCase: Get.find<GoalFundOrderUseCase>(),
