...
class GoalBinding extends Bindings {
  @override
  void dependencies() {
    Get.lazyPut(() => GoalRemoteDataSource(apiService: Get.find<NetworkServicesApi>()));
    Get.lazyPut(() => GoalRepositoryImpl(goalRemoteDataSource: Get.find<GoalRemoteDataSource>()));
    Get.lazyPut(() => SaveGoalUseCase(goalRepository: Get.find<GoalRepositoryImpl>()));
    Get.lazyPut(() => GetGoalsUseCase(goalRepository: Get.find<GoalRepositoryImpl>()));
    Get.lazyPut(() => GoalUseCases(saveGoalUseCase: Get.find<SaveGoalUseCase>(), getGoalsUseCase: Get.find<GetGoalsUseCase>()));
