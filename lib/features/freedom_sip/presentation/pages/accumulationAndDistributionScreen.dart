...
class Accumulationanddistributionscreen extends GetView<FreedomSipController> {
  const Accumulationanddistributionscreen({super.key});

  // Data maps maintained for UI display consistency
  static const accumulationData = {
    "SIP Amount": "₹ 5,000",
    "Tenure": "5 Years",
              ...
              children: [
                ...
                Expanded(
                  child: Container(
                    ...
                    child: TabBarView(
                      children: [
                        _buildDesktopInnerContent(context, accumulationData,
                            "Growth Scheme Details (SIP)", "2025-2030"),
                        _buildDesktopInnerContent(context, distributionData,
                            "Target Scheme Details (SWP)", "2030-2050"),
                      ],
                    ),
                  ),
                ),
  ...
  Widget _buildTabBar(bool isDesktop) {
    return Container(
      ...
      child: TabBar(
        ...
        labelStyle: AppTextStyles.bodyMediumSemiBold(size: isDesktop ? 16 : 14),
        indicatorPadding: const EdgeInsets.all(4),
        tabs: const [Tab(text: "Accumulation"), Tab(text: "Distribution")],
      ),
    );
  }
  ...
  Widget _buildDesktopInnerContent(BuildContext context,
      Map<String, String> schemeData, String title, String period) {
      ...
      child: Column(
        children: [
          ...
          Expanded(
            child: TabBarView(
              children: [
                _buildMobileTabContent(context, accumulationData,
                    "Growth Scheme Details (SIP)", "2025-2030", isTablet),
                _buildMobileTabContent(context, distributionData,
                    "Target Scheme Details (SWP)", "2030-2050", isTablet),
              ],
            ),
          ),
        ],
  ...
  Widget _buildMobileTabContent(BuildContext context,
      Map<String, String> schemeData, String title, String period, bool isTablet) {
    return SingleChildScrollView(
  ...
  Widget _buildChart(
      BuildContext context, String period, bool isDesktop, bool isTablet) {
    return Column(
      children: [
        Container(
  ...
  Widget _buildSchemeDetails(BuildContext context,
      Map<String, String> schemeData, String title, bool isDesktop, bool isTablet) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
        ...
        _buildFundCard(isDesktop, isTablet, schemeData),
      ],
    );
  }

  Widget _buildFundCard(
      bool isDesktop, bool isTablet, Map<String, String> schemeData) {
    return Container(
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Image.asset("assets/images/bandhan_logo.png",
                ...
                child: Center(
                  child: Text('Back',
                      style: AppTextStyles.bodyMedium(
                          color: Ucolors.primary, size: isDesktop ? 16 : 14.0)),
                ),
              ),
            ),
            ...
            Expanded(
              child: UElevatedBUtton(
                ...
                child: Center(
                  child: Text('Checkout',
                      style: AppTextStyles.bodyMedium(
                          color: Colors.white, size: isDesktop ? 16 : 14.0)),
                ),
              ),
            ),
          ],
