                              ...
                              children: [
                                      ...
                                      child: Column(
                                        children: [
                                          Row(
                                            ...
                                            children: [
                                              Text("Projected Value (5y)", style: AppTextStyles.h3(color: Colors.white)),
                                              Text("₹89,682", style: AppTextStyles.bodyLarge(color: Colors.white))
                                            ],
                                          ),
                                          const SizedBox(height: 10),
                                          Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                            children: [
                                              Text("Invested Amount", style: AppTextStyles.bodyMedium(color: Colors.white)),
                                              Text("₹60,000", style: AppTextStyles.bodyLarge(color: Colors.white))
                                            ],
                                          )
                                        ],
                                      ),
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text("Expected Growth Value", style: AppTextStyles.h3(color: Colors.white)),
                                      SizedBox(height: 10,),
                                      RichText(
                                        text: TextSpan(
                                          text: "Your wealth will grow to",
                                          style: AppTextStyles.bodySmall(color: const Color(0xffC9EAFB)),
                                          children: [
                                            TextSpan(text: ' ₹ 4,88,298', style: AppTextStyles.bodySmallBold(color: const Color(0xffC9EAFB))),
                                            TextSpan(text: ' by ', style: AppTextStyles.bodySmall(color: const Color(0xffC9EAFB))),
                                            TextSpan(text: '2030', style: AppTextStyles.bodySmallBold(color: const Color(0xffC9EAFB))),
                                          ],
                                        ),
                                      ),
                                      RichText(
                                        text: TextSpan(
                                          ...
                                          style: AppTextStyles.bodySmall(color: const Color(0xffC9EAFB)),
                                          children: [
                                            TextSpan(text: ' 18 % ', style: AppTextStyles.bodySmallBold(color: const Color(0xffC9EAFB))),
                                            TextSpan(text: 'returns (p.a.) ', style: AppTextStyles.bodySmall(color: const Color(0xffC9EAFB))),
                                          ],
                                        ),
                                      ),
                                    ],
