                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 10),
                              Center(child: Text("This chart highlights the benefits of regular investing\n and does not depicts actual result of investment", style: AppTextStyles.bodySmall(size: 8.sp, color: Colors.white, ),)),
                              const SizedBox(height: 10),
