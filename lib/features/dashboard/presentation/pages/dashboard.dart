        ...
        slivers: [
          ...
          Obx(() {
            ...
            if (controller.selectedIndex.value == 0) {
              ...
              // 1. Handle Loading State (Shimmer Skeleton Cards)
              if (controller.isLoadingPortfolio.value) {
                return SliverList(
                  delegate: SliverChildBuilderDelegate(
                    (context, index) => const PortfolioCardShimmer(),
                    childCount: 3,
                  ),
                );
              }
              ...
              if (controller.isLoadingTransactions.value) {
                return SliverList(
                  delegate: SliverChildBuilderDelegate(
                    (context, index) => const TransactionCardShimmer(),
                    childCount: 4,
                  ),
                );
              }
                        ...
                        onSelected: (value) {
                          switch (value) {
                            ...
                            case PortfolioMenuAction.redemptionDetails:
                              createLog('tap for redemption details');
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  _buildModalRow('Scheme Name', fund.fundName),
                  ...
                  if (fund.folioNo != null && fund.folioNo.isNotEmpty) ...[
                    const Divider(height: 16),
                    _buildModalRow('Folio No', fund.folioNo),
                  ],
