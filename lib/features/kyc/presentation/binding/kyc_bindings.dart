...
class KycBindings extends Bindings{
  ...
  void dependencies() {
    ...
    Get.lazyPut(() => KycUseCases(getAllBanksUseCases: Get.find<GetAllBanksUseCases>(), executePoiStep1UseCase: Get.find<ExecutePoiStep1UseCase>(), executePoiStep2UseCase: Get.find<ExecutePoiStep2UseCase>(), updateFormUseCase: Get.find<UpdateFormUseCase>(), executePoaUseCase: Get.find<ExecutePoaUseCase>()), );
