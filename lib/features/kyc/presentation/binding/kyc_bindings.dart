...
class KycBindings extends Bindings {
  ...
  void dependencies() {
    ...
    Get.lazyPut(
      () =>
          ExecutePoiStep1UseCase(kycRepository: Get.find<KycRepositoryImpl>()),
    );
    Get.lazyPut(() => ExecutePoiStep2UseCase(Get.find<KycRepositoryImpl>()));
    Get.lazyPut(
      () => UpdateFormUseCase(kycRepository: Get.find<KycRepositoryImpl>()),
    );
    Get.lazyPut(
      () => ExecutePoaUseCase(kycRepository: Get.find<KycRepositoryImpl>()),
    );
    Get.lazyPut(
      () =>
    ...
    Get.lazyPut(
      () => GetCaptchaUseCase(kycRepository: Get.find<KycRepositoryImpl>()),
    );
    Get.lazyPut(
      () => GetTokenDataUseCase(kycRepository: Get.find<KycRepositoryImpl>()),
    );
    Get.lazyPut(
      () => CreatePdfUseCase(kycRepository: Get.find<KycRepositoryImpl>()),
    );
    Get.lazyPut(
      () => CreateEsignUrlUseCase(kycRepository: Get.find<KycRepositoryImpl>()),
    );
    Get.lazyPut(
      () => GetEsignDataUseCase(kycRepository: Get.find<KycRepositoryImpl>()),
    );

    Get.lazyPut(
      () => ExecuteVerificationEngineUseCase(
        kycRepository: Get.find<KycRepositoryImpl>(),
      ),
    );
    ...
    Get.lazyPut(
      () => KycUseCases(
        ...
        createPdfUseCase: Get.find<CreatePdfUseCase>(),
        createEsignUrlUseCase: Get.find<CreateEsignUrlUseCase>(),
        getEsignDataUseCase: Get.find<GetEsignDataUseCase>(),
        executeVerificationEngineUseCase:
            Get.find<ExecuteVerificationEngineUseCase>(),
      ),
    );
