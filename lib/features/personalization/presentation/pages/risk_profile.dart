...
class RiskProfile extends GetView<PersonalisationController> {
  ...
  IconData _getIconForQuestion(int index) {
    switch (index) {
      case 0: return Icons.account_balance_wallet_outlined; // Income
      case 1: return Icons.pie_chart_outline;               // Debt
      case 2: return Icons.family_restroom_outlined;        // Dependents
      case 3: return Icons.update;                          // Timeline
      case 4: return Icons.trending_up;                     // Experience
      case 5: return Icons.shield_outlined;                 // Stability
      case 6: return Icons.balance_outlined;                // Risk Appetite
  ...
  Widget build(BuildContext context) {
    ...
    if (!Get.isRegistered<PersonalisationController>()) {
      Get.put(PersonalisationController());
    }
            ...
            children: [
              ...
              Expanded(
                child: PageView.builder(
                  ...
                  physics: const NeverScrollableScrollPhysics(), // User must select option
    ...
    return AppBar(
      ...
      bottom: PreferredSize(
        ...
        child: Obx(() {
          ...
          double targetProgress = (controller.currentQuestionIndex.value + 1) /
              controller.riskQuestions.length;
  ...
  Widget _buildQuestionPage(BuildContext context, RiskQuestion question, int index) {
              ...
              return Obx(() {
                ...
                return InkWell(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: isSelected ? Ucolors.blue.withOpacity(0.05) : Colors.white,
                      border: Border.all(
                      ...
                      boxShadow: isSelected
                          ? [BoxShadow(color: Ucolors.blue.withOpacity(0.12), blurRadius: 12, offset: const Offset(0, 4))]
                        ...
                        AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                              ...
                              width: isSelected ? 7 : 2, // Thicker border fills the circle
                            ),
                          ),
                        ),
...
class _RiskAnalyzingViewState extends State<_RiskAnalyzingView> with TickerProviderStateMixin {
              ...
              child: Stack(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: const Icon(Icons.analytics_outlined, size: 36, color: Ucolors.blue),
                  ),
                ],
              ),
            ),
