...
class UImagePicker {
    ...
    if (isDesktop) {
      ...
      showDialog(
        ...
        builder: (context) => Dialog(
          ...
          child: Container(
            width: 400, // Box ko limit kiya taaki bada na ho
      ...
      showModalBottomSheet(
        ...
        builder: (context) => Container(
          ...
          child: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              // 📱 Mobile ke liye chhota sa drag handle add kiya
              Container(
                height: 4,
                width: 40,
  ...
  static Widget _buildOption({
    ...
    return GestureDetector(
      onTap: onTap,
      child: MouseRegion( // 🚀 FIX: Web par isse cursor pointer (hand) mein badal jayega
